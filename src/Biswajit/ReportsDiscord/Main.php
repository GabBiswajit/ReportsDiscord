...
namespace Biswajit\ReportsDiscord;
...
class Main extends PluginBase implements Listener
{
    ...
    public function reportForm($player) {
        ...
        $form = new CustomForm(function (Player $player, array $data = null){
            ...
            $msg->addEmbed($e);
            $web->send($msg);
            $player->sendMessage("§r§bReport Has Been Sent");
        });
        $name = $player->getName();
    ...
    public function suggestForm($player){
		$form = new CustomForm(function (Player $player, array $data = null){
            ...
            $msg->addEmbed($e);
            $web->send($msg);
            $player->sendMessage("§r§bSuggestions Was Sent");
					return true;
				}
		});
		$name = $player->getName();
    ...
    public function bugForm($player){
		$form = new CustomForm(function (Player $player, array $data = null){
            ...
            $msg->addEmbed($e);
            $web->send($msg);
            $player->sendMessage("§r§bBug Report Has Been Sent");
					return true;
				}
		});
		$name = $player->getName();
